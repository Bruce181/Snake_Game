...
set_property PACKAGE_PIN T1 [get_ports Time_Limit]
    set_property IOSTANDARD LVCMOS33 [get_ports Time_Limit]
set_property PACKAGE_PIN U1 [get_ports Accelerator]
    set_property IOSTANDARD LVCMOS33 [get_ports Accelerator]
set_property PACKAGE_PIN W2 [get_ports Resolution]
    set_property IOSTANDARD LVCMOS33 [get_ports Resolution]
set_property PACKAGE_PIN R3 [get_ports Wall]
